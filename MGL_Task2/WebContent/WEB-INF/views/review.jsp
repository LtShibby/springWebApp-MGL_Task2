		...
		<form name="submitReviewForm" method="POST" action="addReview">
			<table class="table table-dark text-light">
				<tr>
					...
					<td><textarea name="reviewBody" class="form-control"
							placeholder="What did you like/dislike about the game? [required]"
				...
				<tr>
					...
					<td><select id="ratingSelection" name="rating"
						class="chzn-select" style="width: 100px" required>

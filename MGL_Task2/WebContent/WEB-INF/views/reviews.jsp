				...
				<table class="table table-dark table-striped text-light">
					...
					<tbody>
						<tr ng-repeat="currentGame in MGL_T2_ctrl.games">
							...
							<td><span ng-bind="currentGame.game_releaseDate"></span></td>
							<td>
								<button type="button" ng-click="MGL_T2_ctrl.editGame(currentGame)" class="btn btn-primary custom-width">Edit</button>  
								<button type="button" ng-click="MGL_T2_ctrl.deleteGame(currentGame.game_id)" class="btn btn-secondary custom-width">Remove</button>
							</td>
						</tr>
					</tbody>
				</table>
